...
'ethanol': {
        'cpig': [11.7512, 34.8166, 1662.8, 22.4276, 744.7, 0.0, 1226.85],
        'dhv': [15.7235, 1.1905, -1.7666, 1.0012, 0, -114.1, 240.85],
        'psat': [61.7911, -7122.3, 0, 0, -7.1424, 2.8853E-06, 2, -114.1, 240.85],
        'hform': -56.117 * 4.184,
        'mw': 46.069,
        'density': 789.0,
        'bp': 78 + 273
...
def get_properties(components):
        selected_properties = [properties[component] for component in components]
